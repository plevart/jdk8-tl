...
public class LogManager {
    ...
    static class LoggerContext {
        ...
        synchronized void ensureRootLogger(Logger logger) {
            ...
            if (findLogger("") == null) {
                addLocalLogger(RootLogger.INSTANCE);
            }
        }
    ...
    static class RootLogger extends Logger {
        static final RootLogger INSTANCE = new RootLogger();

        private RootLogger() {
            super("", null);
            setLevel(defaultLevel);
            manager.addLogger(this);
            manager.systemContext.addLocalLogger(this);
        }

        public void log(LogRecord record) {
            // Make sure that the global handlers have been instantiated.
            manager.initializeGlobalHandlers();
            super.log(record);
        }
