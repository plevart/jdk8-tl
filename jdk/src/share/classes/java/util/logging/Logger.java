...
public class Logger {
    ...
    // It is needed to skip some initialization that is performed lazily
    private Logger(String name) {
        // we don't call LogManager.getLogManager() here
        // since we don't want to initialize global handlers yet.
        this.manager = LogManager.manager;
        this.name = name;
        levelValue = Level.INFO.intValue();
        // we add global logger in it's construction phase since it is
        // not initialized via static demandLogger() methods
