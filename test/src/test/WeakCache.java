 ...
 * keys and parameters using the {@code subKeyFactory} function passed to the constructor of implementing classes.
...
public interface WeakCache<K, P, V> {
     ...
     * using identity comparison regardless of whether values's class overrides {@link Object#equals} or not.
     *
     * @param value the non-null value to check
     * @return true if given {@code value} is already cached
     * @throws UnsupportedOperationException if this operation is not supported in this instance of cache
     */
    boolean containsValue(V value);

    /**
     * Optional operation. If {@link #containsValue} is supported then this method should be supported too.
     *
     * @return current number of cached entries (can decrease over time when keys/values are GC-ed)
     * @throws UnsupportedOperationException if this operation is not supported in this instance of cache
     */
    int size();
}
