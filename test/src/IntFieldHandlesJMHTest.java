 ...
 */
public class IntFieldHandlesJMHTest
{
    // a volatile field "x"
    volatile int x = 4321;
    ...
    static final AtomicIntegerFieldUpdater<IntFieldHandlesJMHTest> X_FieldUpdater =
        AtomicIntegerFieldUpdater.newUpdater(IntFieldHandlesJMHTest.class, "x");

    // special MH based AtomicIntegerFieldUpdater for operations on field "x" with constant MHs (a subclass per field)
    static final AtomicIntegerFieldUpdater<IntFieldHandlesJMHTest> X_FieldUpdaterMH = new XUpdater();

    static class XUpdater extends AtomicIntegerFieldUpdaterMH<IntFieldHandlesJMHTest> {
    ...
    static {
        try {
            ...
            X_offset = U.objectFieldOffset(IntFieldHandlesJMHTest.class.getDeclaredField("x"));
        } catch (Exception e) {
            throw new Error(e);
        }
    }
    ...
    public static void main(String[] args) throws Throwable {
        ...
        IntFieldHandlesJMHTest t = new IntFieldHandlesJMHTest();

        try {
            System.out.println((int) X.getVolatile.invokeExact((IntFieldHandlesJMHTest) null));
